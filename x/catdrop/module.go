...
import (
	...
	"github.com/DigitalKitchenLabs/coolcat/v1/x/catdrop/client/cli"
...
// Route returns the catdrop module's message routing key.
...
// LegacyQuerierHandler returns the catdrop module's Querier.
